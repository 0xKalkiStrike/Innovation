...
try {
    ...
    echo '<!doctype html><html><head><title>Error</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"><link rel="stylesheet" href="/assets/style.css"></head><body><main class="wrap"><div class="card-section home-card p-5 text-center"><div class="display-3 text-danger">⚠️</div><h1 class="fw-bold text-danger">Submission Error</h1><p class="text-muted">' . htmlspecialchars($e->getMessage()) . '</p><a href="/institution-form.php" class="btn-main text-decoration-none d-inline-block mt-3">Back to Form</a></div></main></body></html>';
    exit;
}
